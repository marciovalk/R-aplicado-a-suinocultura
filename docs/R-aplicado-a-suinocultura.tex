...
\addcontentsline{toc}{subsubsection}{As quatro operações}
...
\addcontentsline{toc}{subsubsection}{Exponenciação}
...
\addcontentsline{toc}{subsubsection}{Logarítimos}
...
\addcontentsline{toc}{subsubsection}{Constantes Matemáticas}
